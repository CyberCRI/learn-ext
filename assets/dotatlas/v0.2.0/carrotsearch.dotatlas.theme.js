...
const ThemeSwitch = function (dotAtlas, options) {
  ...
  const darkColorBands = [
    { "end": 0.0003, "color": [ 0x15, 0x24, 0x2f ], "shading": false, "contours": false },
    ...
    { "end": 0.2,    "color": [ 0x58, 0x6a, 0x2b ], "shading": true,  "contours": true },
    { "end": 0.3,    "color": [ 0x77, 0x81, 0x34 ], "shading": true,  "contours": true },
    { "end": 0.4,    "color": [ 0xbc, 0xb0, 0x26 ], "shading": true,  "contours": true },
    { "end": 0.5,    "color": [ 0x8b, 0x7e, 0x29 ], "shading": true,  "contours": true },
    ...
    { "end": 0.9,    "color": [ 0x86, 0x86, 0x86 ], "shading": true,  "contours": true },
    { "end": 1,      "color": [ 0x99, 0x99, 0x99 ], "shading": true,  "contours": true }
  ];
